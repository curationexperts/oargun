...
module Oargun::RDF
  ...
  module Controlled
    ...
    def self.included(klass)
      ...
      klass.send(:include, Oargun::RDF::DeepIndex) # Force deep indexing for controlled vocabs? Or keep seperate?
    end
    ...
    def set_subject!(uri_or_str)
      ...
      raise ControlledVocabularyError, "Term #{uri_or_str} not in controlled vocabularies for #{self.class}" if vocab_matches.empty?
    ...
    module ClassMethods
      ...
      def name_to_class(name)
        "Oargun::Vocabularies::#{name.upcase.to_s}".constantize
      end
